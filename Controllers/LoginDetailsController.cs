...
using static LoginAPI.Constants.ServiceConstants;
...
namespace LoginAPI.Controllers
{
    ...
    public class LoginDetailsController : ControllerBase
    {
        ...
        {
            var result = await _context.LoginDetails.ToListAsync();
        ...
        public async Task<IActionResult> PutLoginDetails(int id, LoginDetails loginDetails)
        {
            ...
            catch (DbUpdateConcurrencyException ex)
            {
                ...
                {
                    await _logger.LoggAsync(GroupFive.LoginService, EventType.Error, nameof(PutLoginDetails) + "LoginDetails not found " + ex.StackTrace);
                    return NotFound();
                }
                else
                {
